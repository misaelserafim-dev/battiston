...
import { createHooks } from "D:/labtrack/templatePropaganda/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/labtrack/templatePropaganda/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/labtrack/templatePropaganda/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "D:/labtrack/templatePropaganda/node_modules/radix3/dist/index.mjs";
import { defu } from "D:/labtrack/templatePropaganda/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "D:/labtrack/templatePropaganda/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-IIbyT6qR.js")
  },
  {
    name: "orcamento",
    path: "/orcamento",
    component: () => import("./_nuxt/orcamento-BPF9IylB.js")
  },
  {
    name: "resultado",
    path: "/resultado",
    component: () => import("./_nuxt/resultado-BgVHzZ0N.js")
  },
  {
    name: "slug",
    path: "/:slug()",
    component: () => import("./_nuxt/index-H-2YqU0Y.js")
  }
];
...
const fontawesome_JnKv9qFGGymEa8jchv4AtGKiPqz5KDyuOewtt9OIRng = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DZUYSVBE.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Ck0tyVKh.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-obA_Sr16.js"));
